...
const StepResume3: React.FC<Props> = ({handleNextStep}) => {
    const dispatch = useAppDispatch();
    const { resumesState } = useAppSelector(state => state.resumes);

    const nameResume = resumesState.nameResume;

    const selectedEducClass = resumesState.education?.educationClass;
